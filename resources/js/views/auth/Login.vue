    ...
    <div class="login-container">
      <w-card image="/images/login.png" class="login-card" :shadow="false">
        ...
        <form class="mt-6" @submit.prevent="login">
          <w-input label="Usuario" beforeIcon="user" color="tertiary" v-model="form.username"></w-input>
          <w-input label="Contraseña" beforeIcon="unlock" color="tertiary" v-model="form.pass"></w-input>
