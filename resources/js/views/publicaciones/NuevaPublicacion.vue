        ...
        <w-card class="card-nueva-publicacion" :shadow="false">
          ...
          <form @submit.prevent>
              ...
              <div class="form-body" v-if="sections.ubicacion">
                ...
                <div class="w-full md:w-1/3 flex flex-row flex-wrap">
                  <div class="w-full md:w-1/2">
                    <w-checkbox label="Mostrar dirección" v-model="form.mostrardireccion"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/2">
                    <w-checkbox label="Ocultar dirección" v-model="form.ocultardireccion"></w-checkbox>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-section">
              ...
              <div class="form-body" v-if="sections.servicios">
                <div class="flex flex-row flex-wrap">
                  ...
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Conexión a gas" v-model="form.gas"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Telefono" v-model="form.telefono"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Cable" v-model="form.cable"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Internet" v-model="form.internet"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Guardia" v-model="form.guardia"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Servicio de limpieza" v-model="form.limpieza"></w-checkbox>
                  </div>
                  <div class="w-full md:w-1/3 self-center">
                    <w-checkbox class="ml-5" label="Servicio de seguridad" v-model="form.seguridad"></w-checkbox>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="mt-20">
              ...
              <div class="f-header">
                Fotos
                <span class="caption black-text">({{ form.photos.length }} de 20 disponibles)</span>
              </div>
                ...
                <div class="flex flex-row justify-center">
                  <w-card :shadow="false" class="upload-file-card">
                    ...
                    <div class="preview">
                      ...
                      >
                        <slide class="preview-slide" v-for="(media, i) in form.photos" :key="i">
                          <div class="preview-item">
                            <div class="preview-source">
                              <img :src="media.url" />
                              <div class="delete-icon" @click="removePhoto(media)">×</div>
                            </div>
                          </div>
                        </slide>
                      </w-carousel>
              ...
              <div class="f-header">
                Videos
                <span class="caption black-text">({{ form.videos.length }} de 3 disponibles)</span>
              </div>
